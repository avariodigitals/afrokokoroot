...
export function Impact({ stats }: { stats: ImpactMetric[] }) {
  ...
  return (
    <section className="py-24 md:py-32 bg-green-900 text-white relative overflow-hidden">
      ...
      <div className="container relative z-10 text-center">
        <h2 className="text-4xl font-black tracking-tight sm:text-5xl mb-6 text-white drop-shadow-md">Our Impact in Numbers</h2>
        <p className="text-xl text-lime-100/90 max-w-2xl mx-auto mb-16 font-medium">
          Every number represents a life touched, a rhythm shared, and a community strengthened.
        </p>
